...
2. Download the latest release from the [releases page](https://github.com/pcminigames/skyfight/releases). You should get a plugin (`.jar`) and a world folder (`.zip`).
